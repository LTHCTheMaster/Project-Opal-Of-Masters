...
execute as @a[sort=random,limit=1] if score @s mana_points matches 4500.. if score @s cooldownsptr matches ..0 if predicate lthc.opal_core:luck2 if predicate lthc.opal_core:luck2 at @s run function lthc.spells:call_earth_trader
